...
Text fields allow users to edit and input data. They can range from simple search boxes to long-form text areas.
...
<Canvas>
  <Story id="mui-components-text-field--search" />
</Canvas>
